...
<head>
  ...
  <!-- Tempusdominus Bbootsrap 4 -->
  <link rel="stylesheet" href="/assets/adminlte3/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootsrap-4.min.css">
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="/assets/adminlte3/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="/assets/adminlte3/dist/css/adminlte3.min.css">
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <!-- date range picker -->
  <script src="/assets/adminlte3/plugins/daterangepicker/datetrangepicker.js"></script>
  <!-- SweetAlert3 -->
  ...
  <script src="/assets/adminlte3/plugins/datatables-responsive/js/responsive.bootsrap4.min.js"></script>
  <!-- overlayScrollbars -->
  <script src="/assets/adminlte3/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>
  <!-- Tempusdominis Bootstrap 4 -->
  <script src="/assets/adminlte3/plugins/tempusdominus-bootsrap-4/js/tempusdominus-bootsrap-4.min.js"></script>
  <!-- AdminLTE App -->
